...
then invokes ``setup/load_held_out_hotels.py`` so the write path is identical
...
LOADER = REPO_ROOT / "setup" / "load_held_out_hotels.py"
VALIDATOR = REPO_ROOT / "setup" / "validate_graph_amenities.py"
