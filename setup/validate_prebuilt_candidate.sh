...
#
# Usage: setup/validate_prebuilt_candidate.sh [candidate.dump]
#
...
usage() {
  echo "Usage: setup/validate_prebuilt_candidate.sh [candidate.dump]"
...
run_validator "$REPO_ROOT/setup/validate_graph_amenities.py" --mode prebuilt
run_validator "$REPO_ROOT/setup/validate_prebuilt_candidate.py"
