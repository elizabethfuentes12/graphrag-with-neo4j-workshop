...
Your Neo4j connection details are in the Workshop Studio Outputs. In the Code Editor terminal\:
...
Confirm you are in **us-east-1**. Amazon Nova 2 Multimodal Embeddings is only available in us-east-1. Your workshop account has model access pre-enabled — no console changes needed.
:::
