...
| Gap | Fix |
|---|---|
| Tools as in-process functions | **AgentCore Gateway + Lambda** — managed MCP endpoints |
...
:image[AgentCore Gateway sits between the agent and the reservation tools; AgentCore Memory persists facts across sessions]{src="/static/images/03-agentcore-architecture.png" width=800}

---

## Part 1 — Gateway and Lambda Tools

Open `notebooks/04_agentcore_gateway.ipynb`.
...
Open `notebooks/05_agentcore_memory.ipynb`.
