...
> **Historical evaluator warning:** The deterministic source and graph facts in
> this report remain valid. Every factuality and grounding label from the live
> smoke is historical diagnostic output. Grounding labels are invalid for
> publication because the earlier judge could receive truncated evidence. A
> repaired complete-evidence rescore is required before citing any rate.
...
- [x] Retain the merged evidence and stage logs as local diagnostics.
...
- Local live graph and source facts:
  `evidence/release-evidence/live-20260823-final/phase15/graph-facts.json`
- Local merged 24-cell smoke results:
  `evidence/release-evidence/live-20260823-final/phase15/trials/phase15-merged.json`
- Local release-smoke validation log:
  `evidence/release-evidence/live-20260823-final/logs/agent_evidence_gate.log`
- Local per-worker execution logs:
  `evidence/release-evidence/live-20260823-final/logs/agent_evidence_worker_01.log`,
  `agent_evidence_worker_02.log`, and `agent_evidence_worker_03.log`
- Local live-evidence stage manifest:
  `evidence/release-evidence/live-20260823-final/release-evidence.json`

These ignored files have no durable external URI. They are not release evidence
and another clone is not expected to contain them. The tracked compact record is
this report plus `README.md` and `PHASE-1.5-FINDINGS.md` in this directory.
...
local rerun recorded at
`evidence/release-evidence/module3-abstention-fix-20260823-final/summary.json`.
That ignored rerun bundle has no durable URI and is not release evidence. The
original combined manifest remains a local record of the test defect.
